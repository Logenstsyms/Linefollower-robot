...
if(s1==0 && s2==0)    //Хэрэв s1, s2 хар өнгө мэдэрсэн тохиолдолд дараак комманд биелнэ.
{
       digitalWrite(R_2,0);
       digitalWrite(L_2,0);
       digitalWrite(R_1,1);
...
if(s1==1 && s2==1)   //Хэрэв s1, s2 цагаан өнгө мэдэрсэн тохиолдолд дараак комманд биелнэ.
{
       digitalWrite(R_2,0);
       digitalWrite(L_2,0);
       digitalWrite(R_1,1);
...
if(s1==0 && s2==1)   //Хэрэв s1 хар өнгө, s2 цагаан өнгө мэдэрсэн тохиолдолд дараак комманд биелнэ.
{
       digitalWrite(R_2,0);
       digitalWrite(L_2,0);
       digitalWrite(R_1,1);
...
if(s1==1 && s2==0)    //Хэрэв s2 хар өнгө, s1 цагаан өнгө мэдэрсэн тохиолдолд дараак комманд биелнэ.
{
       digitalWrite(R_2,0);
       digitalWrite(L_2,0);
       digitalWrite(R_1,1);
